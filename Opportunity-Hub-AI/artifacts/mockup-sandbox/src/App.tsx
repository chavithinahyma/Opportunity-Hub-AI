...
const opportunities: Opportunity[] = [
  ...
  },
  {
    ...
    category: 'Internship',
    location: 'Across India · 380+ districts',
    workMode: 'On-site, near hometown where possible',
    description: 'Paid internships with India\u2019s top 500 companies, run directly by the Government of India.',
    longDescription: 'The PM Internship Scheme places eligible youth (18\u201325) in structured, paid internships with leading companies across sectors. It is fully free to apply and includes a government-paid stipend. Always register only on the official portal \u2014 no third-party site or agent should ever ask for a fee.',
    deadline: 'Round-based; see portal for current round',
    match: 92,
    skills: ['Any stream', 'Entry-level', 'On-the-job training'],
    posted: 'Round-based',
    applyUrl: 'https://pminternship.mca.gov.in/',
    featured: true,
    accent: '#79b8a3',
    sourceName: 'pminternship.mca.gov.in',
    sourceType: 'Official source',
    currentStatus: 'open',
    statusNote: 'Applications open in rounds; check the portal for the currently open round and eligibility (family income cap applies).',
    cycles: [
      { year: currentYear, status: 'open', note: 'Check the portal for the current round' },
      { year: currentYear + 1, status: 'upcoming', note: 'Scheme runs through 2029; future rounds expected' },
      { year: currentYear + 2, status: 'upcoming', note: 'Scheme runs through 2029; future rounds expected' },
    ],
  },
  {
    ...
    category: 'Internship',
    location: 'Across India · online and on-site',
    workMode: 'Flexible, project-based',
    description: 'Verified technical and management internships for students, free to register and apply.',
    longDescription: 'AICTE\u2019s National Internship Portal connects students at AICTE-approved institutions with verified internships across 200+ domains, including government TULIP internships. Registration and applications are free \u2014 AICTE explicitly warns against anyone charging a fee in its name.',
    deadline: 'Rolling; varies by listing',
    match: 84,
    skills: ['Engineering', 'Management', 'IT & data'],
    posted: 'Rolling listings',
    applyUrl: 'https://internship.aicte-india.org/',
    featured: false,
    accent: '#c9a86a',
    sourceName: 'internship.aicte-india.org',
    sourceType: 'Official source',
    currentStatus: 'open',
    statusNote: 'Listings are posted on a rolling basis; check the portal for what is currently open near you.',
    cycles: [
      { year: currentYear, status: 'open', note: 'Live listings on the portal now' },
      { year: currentYear + 1, status: 'upcoming', note: 'Expected to continue as an ongoing programme' },
      { year: currentYear + 2, status: 'upcoming', note: 'Expected to continue as an ongoing programme' },
    ],
  },
  {
    id: 'ibps-recruitment',
    title: 'IBPS bank recruitment (PO / Clerk / RRB)',
    company: 'Institute of Banking Personnel Selection',
    category: 'Government',
    location: 'Across India',
    workMode: 'On-site, branch-assigned',
    description: 'The official route into public-sector and regional rural bank jobs \u2014 no agent required.',
    longDescription: 'IBPS conducts the common recruitment process for public-sector banks and Regional Rural Banks (Probationary Officer, Clerk, and Officer Scale I/II/III). IBPS has publicly warned that all recruitment happens only through ibps.in \u2014 treat any other site or paid \u201chelper\u201d as suspicious.',
    deadline: 'See current notification',
    match: 89,
    skills: ['Banking aptitude', 'Reasoning', 'English & GK'],
    posted: 'Calendar-based',
    ...
    sourceType: 'Official source',
    currentStatus: 'not-announced',
    statusNote: 'Exams run on an annual calendar; check ibps.in for the current notification and dates.',
    cycles: [
      { year: currentYear, status: 'not-announced', note: 'Check the current CRP notification' },
      { year: currentYear + 1, status: 'upcoming', note: 'Annual recruitment cycle expected' },
      { year: currentYear + 2, status: 'upcoming', note: 'Annual recruitment cycle expected' },
    ],
  },
  {
    id: 'rrb-railway-recruitment',
    title: 'Railway Recruitment Board (RRB) jobs',
    company: 'Ministry of Railways, Govt of India',
    category: 'Government',
    location: 'Across India · zone-wise',
    workMode: 'On-site',
    description: 'Official notifications for one of India\u2019s largest government employers, zone by zone.',
    longDescription: 'Railway Recruitment Boards fill technical, non-technical, and group posts across Indian Railways. RRBs explicitly warn candidates to use only official RRB websites and to ignore recruitment claims circulated on social media.',
    deadline: 'See current CEN notification',
    match: 87,
    skills: ['10th/12th/Diploma/Grad roles', 'Technical & non-technical'],
    posted: 'CEN-based',
    applyUrl: 'https://www.rrbapply.gov.in/',
    featured: false,
    accent: '#e39a9a',
    sourceName: 'rrbapply.gov.in',
    sourceType: 'Official source',
    currentStatus: 'not-announced',
    statusNote: 'Openings are tied to a specific CEN (Centralised Employment Notice); check the current one before applying.',
    cycles: [
      { year: currentYear, status: 'not-announced', note: 'Check the active CEN notification' },
      { year: currentYear + 1, status: 'upcoming', note: 'New CEN cycles expected through the year' },
      { year: currentYear + 2, status: 'upcoming', note: 'Not announced yet' },
    ],
  },
  {
    id: 'appsc-jobs',
    title: 'APPSC recruitment (Andhra Pradesh)',
    company: 'Andhra Pradesh Public Service Commission',
    category: 'Government',
    location: 'Andhra Pradesh',
    workMode: 'On-site, state cadre',
    description: 'State government exams and posts for Andhra Pradesh \u2014 Groups, TET, DSC, and more.',
    longDescription: 'APPSC conducts recruitment for state civil service and departmental posts in Andhra Pradesh, including Group 1/2/4, TET, and DSC. Register once with an OTPR ID and use it for every APPSC application; always confirm dates against the official notification, not forwarded messages.',
    deadline: 'See current notification',
    match: 85,
    skills: ['State services', 'Group exams', 'Eligibility & OTPR'],
    posted: 'Notification-based',
    applyUrl: 'https://psc.ap.gov.in/',
    featured: false,
    accent: '#e8b25f',
    sourceName: 'psc.ap.gov.in',
    sourceType: 'Official source',
    currentStatus: 'not-announced',
    statusNote: 'Recruitment opens only when APPSC publishes a notification for a specific Group or post.',
    cycles: [
      { year: currentYear, status: 'not-announced', note: 'Check active notifications on the portal' },
      { year: currentYear + 1, status: 'upcoming', note: 'Annual Group exam cycle expected' },
      { year: currentYear + 2, status: 'upcoming', note: 'Not announced yet' },
    ],
  },
  {
    id: 'tspsc-jobs',
    title: 'TSPSC recruitment (Telangana)',
    company: 'Telangana Public Service Commission',
    category: 'Government',
    location: 'Telangana',
    workMode: 'On-site, state cadre',
    description: 'State government exams and posts for Telangana \u2014 Groups, departmental exams, and more.',
    longDescription: 'TSPSC (also referred to as TGPSC) conducts recruitment for Telangana state civil service and departmental posts. Notifications, hall tickets, and results are published only on the official site; the commission has flagged fraudulent recruitment claims in the past.',
    deadline: 'See current notification',
    match: 85,
    skills: ['State services', 'Group exams', 'Departmental exams'],
    posted: 'Notification-based',
    applyUrl: 'https://www.tspsc.gov.in/',
    featured: false,
    accent: '#8fbf8f',
    sourceName: 'tspsc.gov.in',
    sourceType: 'Official source',
    currentStatus: 'not-announced',
    statusNote: 'Recruitment opens only when TSPSC publishes a notification for a specific Group or post.',
    cycles: [
      { year: currentYear, status: 'not-announced', note: 'Check active notifications on the portal' },
      { year: currentYear + 1, status: 'upcoming', note: 'Annual Group exam cycle expected' },
      { year: currentYear + 2, status: 'upcoming', note: 'Not announced yet' },
